...
headers = {
    "PRIVATE-TOKEN": "glpat-kasiVZfmA7gnLKwqyxJK"
}
for sf in smell_files:
    ...
    gitlab_output = requests.post(f"https://git.cs.dal.ca/api/v4/projects/{67470}/issues?{query_params}",headers=headers, data=body)
